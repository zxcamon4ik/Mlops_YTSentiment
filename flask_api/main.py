...
def predict_with_timestamps():
    ...
    try:
        ...
        # Extract feature names and create DataFrame to satisfy MLflow schema
        feature_names = vectorizer.get_feature_names_out() 
        df_comments = pd.DataFrame(dense_comments, columns=feature_names)
        
        # Make predictions using the DATAFRAME, not the dense array
        predictions = model.predict(df_comments).tolist()  
